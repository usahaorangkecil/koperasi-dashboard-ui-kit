...
import { Home, User, Smartphone, FileText, Info, BarChart2, Bell } from 'lucide-react';
        ...
        <section className="py-12 bg-white">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 max-w-2xl mx-auto">
              {[
                { icon: FileText, title: "Cek Riwayat" },
                { icon: FileText, title: "Ajukan Pinjaman" },
